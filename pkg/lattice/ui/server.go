...
func (s *Server) routes() *http.ServeMux {
	...
	mux.HandleFunc("GET /journeys/{id}", s.pageJourney)
	mux.HandleFunc("GET /actors", s.pageActors)
	mux.HandleFunc("GET /actors/{id}", s.pageActor)
	...
	mux.HandleFunc("GET /rtm", s.pageRTM)
	...
	mux.HandleFunc("GET /api/v1/journeys/{id}", s.apiJourney)
	mux.HandleFunc("GET /api/v1/actors", s.apiActors)
	mux.HandleFunc("GET /api/v1/actors/{id}", s.apiActor)
	...
	mux.HandleFunc("GET /api/v1/rtm", s.apiRTM)
